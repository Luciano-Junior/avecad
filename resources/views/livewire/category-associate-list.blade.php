<div>
                    ...
                    <tr wire:key="category-{{ $category->id }}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 "
                        ...
                        <td class="px-6 py-4 text-right flex gap-2">
                            ...
                            <button 
                                ...
                                title="Excluir"
                                x-data
                                @click="if (confirm('Deseja realmente excluír este registro?')) { $wire.deleteCategory({{ $category }}) }"
                            >
    ...
    <x-modal name="edit-category">
        @include('category_associate.partials.update-category')
    </x-modal>
    <x-modal name="store-category">
        @include('category_associate.partials.store-category')
    </x-modal>
</div>