        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="grid justify-items-end">
                <a href="{{route('associate.register')}}">
                    <button class="p-2 flex text-sm items-center sm:rounded-lg uppercase bg-blue-500 text-white dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-gray-300 gap-2">
                        {{__('New')}}
                        ...
                        @foreach ($associates as $associate)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 ">
                                ...
                                <td class="px-6 py-4 text-right flex gap-2">
                                    ...
                                    <x-nav-link-table href="#" :active="true" class="hover:underline" title="Mensalidades">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
