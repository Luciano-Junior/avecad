    ...
    <form method="post" action="{{ route('associate.update', $associate->id) }}" enctype="multipart/form-data" class="mt-6 space-y-6 px-3" x-data="{ previewUpload: null }">
            ...
            <div x-data="{
                ...
                <div>
                    ...
                    <div class="flex gap-2 items-center">
                        <x-text-input id="birth_date" name="birth_date" type="date" class="mt-1 block w-full" x-model="birth_date" />
        ...
        <div class="grid grid-cols-3 gap-2">
            ...
            <div>
                ...
                <x-text-input id="associate_admission_date" name="associate_admission_date" type="date" class="mt-1 block w-full" :value="old('associate_admission_date', $associate->admission_date ? $associate->admission_date->format('Y-m-d') : '')" autocomplete="admission_date" />
